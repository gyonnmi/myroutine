...
public class RoutineController {
    ...
    public String addRoutine( // 새로운 루틴을 추가하는 메서드
    ...
    public String updateRoutine( // 기존 루틴을 수정하는 메서드
    ...
    public String deleteRoutine(@PathVariable Long id) { // 루틴 ID를 경로 변수로 받아서 삭제 처리
    ...
    @ResponseBody
    public void updateCompleted( // 루틴 완료 상태를 업데이트하는 메서드
            @PathVariable Long id,
